...
//https://www.youtube.com/watch?v=QLTUYcCGjQk
...
// Declares a variable named CursorPosition of type COORD to hold X and Y coordinates
COORD CursorPosition;

// Moves the console cursor to the specified X and Y coordinates
